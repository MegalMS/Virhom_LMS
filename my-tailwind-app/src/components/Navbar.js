          ...
          >
            <div className="flex justify-between items-center px-8 py-4">
              ...
              <div className="flex items-center gap-4">
                {/* <button className="flex items-center gap-2 px-4 py-2 border-2 border-[#CBB59D] text-[#6B4F4F] rounded-lg hover:bg-[#F5F1ED] transition-all duration-300 hover:scale-105">
                  <Globe size={16} />
